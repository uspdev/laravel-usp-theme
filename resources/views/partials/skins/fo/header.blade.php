    ...
    <div class="row">
        <div class="col-md-12">
            <a class="skin_logo float-left" href="{{ config('app.url')}}">
                <img src="{{ asset('/vendor/laravel-usp-theme/skins/fo/images/logo_fo.png') }}" alt="Logo da FO - Faculdade de Odontologia" />
            </a>
            <div class="float-left pr-1 pt-2">
                <div>{{ config('app.name')}} </div>
                <div class="small">Faculdade de Odontologia</div>
            </div>
            <div class="skin_logo  float-right pr-1 pt-2">
                <img src="{{ asset('/vendor/laravel-usp-theme/skins/fo/images/usp.png') }}" alt="Logo da Universidade de São Paulo" />
            </div>
        </div>
    </div>
</div>
